...
if ($aksi == "ubahdata") {
    ...
    $sandi = $_POST['sandi'];
    $telp = $_POST['telp'];
    $kueri_edit = "UPDATE petugas SET nama_petugas='" . $nama . "', username='" . $pengguna . "',
password='" . $sandi . "', telp='" . $telp . "' WHERE id_petugas='" . $id_petugas . "' ";
    ...
    $query = mysqli_query($konek, "INSERT INTO tanggapan VALUES('','" . $id_pengaduan . "',now(),
'" . $isi_tanggapan . "', '" . $id_petugas . "')");

    if ($query) {
        mysqli_query($konek, "UPDATE pengaduan SET status='" . $status . "' WHERE
id_pengaduan='" . $id_pengaduan . "' ");
    ...
    $sandi = $_POST['sandi'];
    $telp = $_POST['telp'];
    $kueri_tambah = "INSERT INTO petugas VALUES ('','" . $nama . "', '" . $pengguna . "', '" . $sandi . "',
'" . $telp . "', 'petugas' )";
    ...
    $kueri_edit = "UPDATE petugas SET nama_petugas='" . $nama . "', username='" . $pengguna . "', password='" . $sandi . "', no_telp='" . $telp . "' WHERE id_petugas='" . $id_petugas . "' ";
    if (mysqli_query($konek, $kueri_edit)) {
    ...
    $sandi = $_POST['sandi'];
    $telp = $_POST['telp'];
    $kueri_tambah = "INSERT INTO masyarakat VALUES ('$nik','$nama', '$pengguna', '$sandi',
'$telp' )";
    if (mysqli_query($konek, $kueri_tambah)) {
        echo "<h1 style='color:green; text-align:center'>Data berhasil ditambah</h1>";
    ...
    $kueri_edit = "UPDATE masyarakat SET nama='$nama', username='$pengguna',
password='$sandi', telp='$telp' WHERE NIK='$nik' ";
    if (mysqli_query($konek, $kueri_edit)) {
        echo "<h1 style='color:green; text-align:center'>Data berhasil diedit</h1>";
        echo "<meta http-equiv='refresh' content='1; URL=registrasi.php'>";
    } else {
