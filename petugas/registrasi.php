...
$id_petugas = mysqli_real_escape_string($konek, $_SESSION['ses_idpetugas']);
$kueri_identitas = mysqli_query($konek, "SELECT * FROM petugas WHERE id_petugas = '$id_petugas'");
...
<body>
 ...
 <a
href='aksipetugas.php?a=hapusmasyarakat&id=" . $data_masy[0] . "'>Hapus</a>
 </td></tr>";
                }
                ?>
            </table>
