...
<body>
    ...
    <div class="container">
        <div class="content">
            ...
            <table width="100%">
                <tr>
                    <td width="20%" class="headertabel">Tanggal</td>
                    <td class="headertabel">Isi</td>
                    <td class="headertabel">Status</td>
                    <td class="headertabel">Tanggapan</td>
                </tr>
                <?php
                $kueri_pengaduan = mysqli_query($konek, "SELECT * FROM pengaduan ORDER
BY tgl_pengaduan DESC");
 ...
 <td>
 <a href='tanggapan.php?id=" . $data_pengaduan[0] . "'>Lihat
Tanggapan</a> </td></tr>";
                }
                ?>
            </table>
