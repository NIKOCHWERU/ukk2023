        ...
        <div class="content">
            ...
            <form name="f_tambahdata" method="post" action="aksipetugas.php?a=tambahmasyarakat">
                <table border="0">
                    <tr>
                        <td>NIK</td>
                        <td><input type="text" name="nik" class="inputan"></td>
                    </tr>
                    <tr>
                        <td>Nama Lengkap</td>
                    ...
                    <tr>
                        <td>No Telp</td>
                        <td><input type="text" name="telp" class="inputan"></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td><input type="submit" value="Tambah Data" class="tombol"><input type="reset" value="Reset"
                                class="tombol"></td>
                    </tr>
                </table>
            </form>
