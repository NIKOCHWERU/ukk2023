    ...
    <div class="row">
        ...
        <div class="kiri">
            ...
            <table width="100%" border="0">
                ...
                // $kueri = mysqli_query($konek, "SELECT a.tgl_pengaduan, a.isi_laporan, a.status, COUNT(c.id_tanggapan) as jml, b.nama, a.foto FROM pengaduan a, masyarakat b, tanggapan c WHERE b.nik=a.nik AND c.id_pengaduan=a.id_pengaduan GROUP BY a.id_pengaduan ORDER BY a.tgl_pengaduan DESC LIMIT 10 ");
        ...
        <!-- <div class="kanan">
            ...
            <form name="flogin" method="post" action="aksi.php?a=login">
                <table border="0">
                    <tr>
                        <td>Username</td>
                        <td> <input type="text" name="pengguna" placeholder="username anda"> </td>
                    </tr>
                    <tr>
                        <td>Password</td>
            ...
            Belum memiliki akun? <a href="registrasi.php">Registrasi</a><br><br><a href="loginpetugas.php">Login
                Petugas</a>
        </div> -->
    </div>
    <footer>
